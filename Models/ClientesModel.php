...
class ClientesModel extends Query
{
    ...
    public function agregarCalificacion($cantidad, $id_producto, $id_cliente)
    {
        ...
        $this->actualizarCalificacionPromedioProducto($id_producto);
        return $res;
    }
    ...
    public function calcularCalificacionPromedioProducto($id_producto)
    {
        $sql = "SELECT AVG(cantidad) AS calificacion_promedio FROM calificaciones WHERE id_producto = $id_producto";
        return $this->select($sql);
    }

    public function actualizarCalificacionPromedioProducto($id_producto)
    {
        $sql = "UPDATE productos SET calificacion_promedio = (SELECT AVG(cantidad) FROM calificaciones WHERE id_producto = $id_producto) WHERE id = $id_producto";
