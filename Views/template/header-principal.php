...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Mulish:ital,wght@0,400;0,500;0,600;1,400;1,500;1,600&display=swap" rel="stylesheet">
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                ...
                <div class="navbar align-self-center d-flex">
                    ...
                    <?php if (!empty($_SESSION['correoCliente'])) { ?>
                        <div class="dropdown">
                            <a class="nav-icon position-relative text-decoration-none dropdown-toggle" href="#" role="button" id="profileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="img-thumbnail" src="<?php echo BASE_URL . 'assets/images/clientes/defaultprofile.png' ?>" alt="-LOGO-CLIENTE" width="50" style="background: transparent; border: 0;">
                            </a>
                            <div class="dropdown-menu" aria-labelledby="profileDropdown">
                                <a class="dropdown-item" href="<?php echo BASE_URL . 'clientes'; ?>"><i class="fas fa-user"></i> Perfil </a>
